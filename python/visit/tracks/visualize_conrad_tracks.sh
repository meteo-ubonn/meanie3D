...
cat ${MEANIE3D_HOME}/scripts/visit/tracks/visualize_conrad_tracks.py | sed -e "s/P_SOURCE_DIR/$ESCAPED_SOURCE_DIR/g" | sed -e "s/P_BASENAME/$ESCAPED_BASENAME/g" | sed -e "s/P_M3D_HOME/$ESCAPED_MEANIE3D_HOME/g" > ${SCRIPTFILE}
