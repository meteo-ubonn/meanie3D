...
cat $MEANIE3D_HOME/visit/tracking/run_radar_tracking-3D.py | sed -e "s/P_SOURCE_DIR/$ESCAPED_SOURCE_DIR/g" | sed -e "s/P_M3D_HOME/$ESCAPED_MEANIE3D_HOME/g" | sed -e "s/P_SCALE/$2/g" | sed -e "s/P_RESUME/$resume/g" > $SCRIPTFILE
