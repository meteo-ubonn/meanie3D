...
CONVERSION_PARAMS += " --vtk-dimensions xt,yt"
...
time_slices = int(float(SLICES))

for time_index in xrange(0, time_slices):
    ...
    cluster_file            = CLUSTER_DIR+"/"+basename +"-clusters_" +str(time_index) + ".nc"
    label_file              = basename+"-clusters_"+str(time_index)+"_centers.vtk"
    ...
    print "Visualizing file "+netcdf_file+" and cluster file "+cluster_file
