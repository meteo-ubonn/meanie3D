...
cat $MEANIE3D_HOME/visit/loops/create_oase_loop_2D.py | sed -e "s/SOURCE_DIR_P/$ESCAPED_NETCDF_DIR/g" | sed -e "s/VARIABLE_P/$2/g" | sed -e "s/COLOR_TABLE_P/$COLOR_TABLE/g" | sed -e "s/COLOR_TABLE_INVERT_P/$INVERT_COLOR_TABLE/g" | sed -e "s/MEANIE3D_HOME_P/$ESCAPED_MEANIE3D_HOME/g" > ${SCRIPTFILE}
