...
cat $MEANIE3D_HOME/visit/visualize_cluster_weights_3D.py | sed -e "s/SOURCE_FILE_P/$ESCAPED_SOURCE_DIR/g" | sed -e "s/M3D_HOME_P/$ESCAPED_MEANIE3D_HOME/g" | sed -e "s/VAR_NAME_P/$2/g"> $SCRIPTFILE
