...
usage() {
    ...
    echo "Creates a python script for visualizing 3D source and clusters for the meanie3D project."
...
cat $MEANIE3D_HOME/scripts/visit/clusters/visualize_clusters_3D.py \
